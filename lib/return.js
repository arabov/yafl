...
(function() {
	...
	var TYPE_ARRAY = 0, TYPE_OBJECT = 1, TYPE_LIST = 2, TYPE_NUMBER = 3, TYPE_DB = 4;
	...
	Monad.prototype.init = function(n) {
		switch (this._type) {
            ...
            case TYPE_DB:
                //todo apply
                this._pointer = this._wrapped.order(this._global,'');
                break;
			default:
	...
	Monad.prototype.value = function() {
		switch (this._type) {
            ...
            case TYPE_DB:
                if (this._pointer !== null) {
                    switch (this._wrapped.data(this._global,this._pointer)) {
                        case '10':
                            //todo return { val: '', children: new Monad }
                            /*
                            var newMonad = new Monad(this._wrapped);
                            newMonad._pointer = this._wrapped.order(this._global, this._pointer);
                            return newMonad;
                            */
                            break;
                        case '1':
                            return this._wrapped.get(this._global, this._pointer);
                        case '0':
	...
	Monad.prototype.next = function() {
		...
		switch (this._type) {
            ...
            case TYPE_DB:
                //todo apply
                this._pointer = this._wrapped.order(this._global, this._pointer);
                if (this._pointer === '') {
                    this._pointer = null;
                }
                return this._pointer;
